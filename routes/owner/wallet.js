...
const { getMyWallet, getMyTransactions, getRevenueSummary, getRevenueSeries, createWithdrawRequest } = require('../../controllers/owner/walletController');
...
router.get('/wallet/revenue-series', asyncHandler(getRevenueSeries));
